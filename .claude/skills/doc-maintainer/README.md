...
| 类型前缀 | 博客、规范等使用前缀 | `[Blog] 2026-07-05-topic.md` |

详细命名规则请参见 [naming-conventions.md](./guides/naming-conventions.md)。
...
博客文章遵循特殊的写作原则，使用 `[Blog]` 前缀命名，强调图文并茂、减少技术代码。详细指南请参见 [blog-writing.md](./guides/blog-writing.md)。

**核心要点：**

| 原则 | 说明 |
|------|------|
| 减少技术代码 | 用流程图代替代码逻辑，用类比解释复杂概念 |
| 图文并茂 | 使用 ASCII 流程图、表格对比、示意图说明 |
| 便于理解 | 用案例解释复杂逻辑，用故事串联知识点 |
| 结构清晰 | 引言 -> 设计 -> 实现 -> 测试 -> 总结 |
...
- 新增博客写作指南（`guides/blog-writing.md`）
- 新增文档命名规则（`guides/naming-conventions.md`）
- 更新 SKILL.md 增加博客写作功能说明
- 更新 README.md 增加博客写作最佳实践
