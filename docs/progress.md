...
| 里程碑 | 目标日期 | 状态 | 说明 |
|--------|---------|------|------|
| M1: 基础架构 | Week 2 | 🔄 进行中 | 项目结构、配置文件 |
| M2: 核心协议 | Week 4 | ⏳ 待开始 | JSON-RPC 实现 |
| M3: Agent 核心 | Week 8 | ⏳ 待开始 | Agent Loop、工具系统 |
